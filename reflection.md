...
5. Thanks to the reviewer and the course mentor, there are many popular ways to systematically tune the PID parameters. Here are a [video](https://www.youtube.com/watch?v=4Y7zG48uHRo) discussing the effect of the D component, a nice [discussion](https://robotics.stackexchange.com/questions/167/what-are-good-strategies-for-tuning-pid-loops) on the common ways people use for tuning, and a [more mathmatical review](https://udacity-reviews-uploads.s3.amazonaws.com/_attachments/41330/1493863065/pid_control_document.pdf) of the PID theory.
